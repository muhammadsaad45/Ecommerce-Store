...
export default function ProductImageGallery({ images, alt, stock }: ProductImageGalleryProps) {
  ...
  if (galleryImages.length === 0) {
    return (
      <div className="bg-gray-50 rounded-3xl p-8 flex items-center justify-center border border-gray-100 relative overflow-hidden min-h-128">
        {stock <= 0 && (
    ...
    <>
      ...
      <div className="bg-gray-50 rounded-3xl p-5 sm:p-8 border border-gray-100 relative overflow-visible">
        ...
        {zoomEnabled && isHovering && (
          <div className="pointer-events-none absolute left-[calc(100%+1.5rem)] top-0 z-60 block h-136 w-136 overflow-hidden rounded-3xl border border-white/40 bg-black/85 shadow-2xl lg:h-152 lg:w-152 xl:h-160 xl:w-160">
            <div
