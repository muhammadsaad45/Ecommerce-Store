...
export default function AddProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // THE FIX: Force price and stock to be true numbers
      const formattedData = {
        ...formData,
      ...
      // Send the FORMATTED data to our backend route
      const response = await fetch("/api/products", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify(formattedData), // Using formattedData here!
      });
